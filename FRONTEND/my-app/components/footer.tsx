  ...
  return (
    <footer className="py-16 md:py-32 bg-background">
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-sm mb-8">
          {/* X/Twitter */}
          <Link href="#" target="_blank" rel="noopener" aria-label="X/Twitter">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <path
                fill="currentColor"
                d="M10.488 14.651L15.25 21h7l-7.858-10.478L20.93 3h-2.65l-5.117 5.886L8.75 3h-7l7.51 10.015L2.32 21h2.65z"
              />
            </svg>
          </Link>
          {/* LinkedIn */}
          ...
          {/* Facebook */}
          <Link href="#" target="_blank" rel="noopener" aria-label="Facebook">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <path
                fill="currentColor"
          ...
          {/* Threads */}
          <Link href="#" target="_blank" rel="noopener" aria-label="Threads">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <path
                fill="none"
                stroke="currentColor"
          ...
          {/* Instagram */}
          <Link href="#" target="_blank" rel="noopener" aria-label="Instagram">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <path
                fill="currentColor"
          ...
          {/* TikTok */}
          <Link href="#" target="_blank" rel="noopener" aria-label="TikTok">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <path
                fill="currentColor"
